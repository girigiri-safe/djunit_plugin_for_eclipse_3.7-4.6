...
//	}
	...
	private String[] addDJUnitClassPath(ILaunchConfiguration configuration, String[] cp)
		...
		try {
			...
			newClassPath = new String[cp.length + junitEntries.size()];
			Object[] jea = junitEntries.toArray();
			System.arraycopy(cp, 0, newClassPath, 0, cp.length);
			System.arraycopy(jea, 0, newClassPath, cp.length, jea.length);
